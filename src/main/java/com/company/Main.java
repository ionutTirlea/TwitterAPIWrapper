...
public class Main {
    ...
    private static String requestBearerToken(String endPointUrl) throws IOException {
        ...
        String encodedCredentials = encodeKeys(Config.CONSUMER_KEY,Config.CONSUMER_SECRET);
        ...
        try {
            ...
            connection.setRequestProperty("User-Agent", "IonutTirleaHatespeechDetection v1.0");
